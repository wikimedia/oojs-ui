 ...
 * @constructor
 */
OO.ui.OasisTheme = function OoUiOasisTheme() {
	// Parent constructor
	OO.ui.OasisTheme.parent.call( this );
};

/* Setup */

OO.inheritClass( OO.ui.OasisTheme, OO.ui.Theme );
 ...
 * @inheritdoc
 */
OO.ui.OasisTheme.prototype.getElementClasses = function ( element ) {
	// Parent method
	var variant, isFramed, isActive, isToolOrGroup,
		...
		// Parent method
		classes = OO.ui.OasisTheme.parent.prototype.getElementClasses.call( this, element );
 ...
 * @inheritdoc
 */
OO.ui.OasisTheme.prototype.getDialogTransitionDuration = function () {
	return 250;
};

/* Instantiation */

OO.ui.theme = new OO.ui.OasisTheme();
